<nav x-data="{ open: false }" class="bg-white border-b border-gray-800">
  ...
  <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
    ...
    <div class="pt-2 pb-3 space-y-1">
      <x-responsive-nav-link :href="route('conversations.mutual_follow')" :active="request()->routeIs('conversations.mutual_follow')">
        {{ __('会話') }}
      </x-responsive-nav-link>
    </div>
