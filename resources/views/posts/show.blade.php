        ...
        <div class="p-6 bg-white border-b border-gray-200">
          <div class="mb-6">
            <div class="flex flex-col mb-4">
              <p class="mb-2 uppercase text-gray-800 dark:text-gray-200">タイトル</p>
              <p class="py-2 px-3 text-gray-800 dark:text-gray-200" id="title">
                {{$post->title}}
              </p>
            </div>
            <div class="flex flex-col mb-4">
              <p class="mb-2 uppercase text-gray-800 dark:text-gray-200">内容</p>
              <p class="py-2 px-3 text-gray-800 dark:text-gray-200" id="content">
                {{$post->content}}
              </p>
            </div>
            <div class="flex flex-col mb-4">
              <p class="mb-2 uppercase text-gray-800 dark:text-gray-200">ニックネーム</p>
              <p class="py-2 px-3 text-gray-800 dark:text-gray-200" id="nickname">
                {{$post->user->nickname}}
              </p>
            </div>
            <div class="flex flex-col mb-4">
              <p class="mb-2 uppercase text-gray-800 dark:text-gray-200">日時</p>
                ...
                {{$post->created_at}}
                  ...
                  <div class="flex">
                    ...
                    <form action="{{ route('likes',$post) }}" method="POST" class="text-left">
                      @csrf
                      <x-primary-button class="ml-3">
                        <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke-width="1.5" width="30" height="30" color="#FFFFFF"><defs><style>.cls-63ce749bea57ea6c83800628-1{fill:none;stroke:currentColor;stroke-miterlimit:10;}</style></defs><path class="cls-63ce749bea57ea6c83800628-1" d="M1.5,18.73H3.41l5,2.87a7.22,7.22,0,0,0,3.57.95h0"></path><polyline class="cls-63ce749bea57ea6c83800628-1" points="19.16 19.55 20.59 18.73 22.5 18.73"></polyline><path class="cls-63ce749bea57ea6c83800628-1" d="M12,22.55a7.22,7.22,0,0,0,3.57-.95l2-1.16-3.68-5.53-2.65.66a3.42,3.42,0,0,1-.79.09A3.26,3.26,0,0,1,9,15.32a1.49,1.49,0,0,1,.08-2.71l5.07-2.17a3.69,3.69,0,0,1,1.48-.3,3.74,3.74,0,0,1,2.08.63l1.92,1.28H22.5"></path><path class="cls-63ce749bea57ea6c83800628-1" d="M1.5,12.05H4.36l1.92-1.28a3.74,3.74,0,0,1,2.08-.63,3.69,3.69,0,0,1,1.48.3l2.16.93"></path><line class="cls-63ce749bea57ea6c83800628-1" x1="22.5" y1="10.14" x2="22.5" y2="20.64"></line><line class="cls-63ce749bea57ea6c83800628-1" x1="1.5" y1="10.14" x2="1.5" y2="20.64"></line><polygon class="cls-63ce749bea57ea6c83800628-1" points="12 3.46 12.46 4.4 13.51 4.55 12.75 5.28 12.93 6.32 12 5.83 11.07 6.32 11.25 5.28 10.49 4.55 11.54 4.4 12 3.46"></polygon></svg>
                        <span style="margin-left: 8px;">{{ $post->likes()->count() }}</span>
                      </x-primary-button>
                    </form>
                    @endif
            ...
            <section class="bg-gray-100 py-8 px-4">
              <div class="max-w-2xl mx-auto">
                <form action="{{ route('replies.store', $post) }}" method="post" class="mt-8">
                  @csrf
                  <div class="mb-4">
                    <label for="content" class="block text-sm font-semibold mb-2">返信作成</label>
                    <textarea name="content" id="content" rows="3" class="w-full p-2 border rounded-lg focus:outline-none focus:border-blue-500">{{ old('content') }}</textarea>
                    @error('content')
                    <p class="text-red-500 text-sm mt-2">{{ $message }}</p>
                    @enderror
                  </div>
                  <div>
                    <button type="submit" class="bg-blue-500 text-gray px-4 py-2 rounded-lg hover:bg-blue-600">返信</button>
                  </div>
                </form>
